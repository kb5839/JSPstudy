...
<body>
	...
	<table align="center" width="210" cellpadding="2" cellspacing="1">
		<tr>
			<td align="center"><a href="calendar.jsp" style="text-decoration: none;"></a>
	...
	<table align="center" width="250" cellpadding="0" cellspacing="1"
		bgcolor="black">
		<tr>
			<td bgcolor="white" align="center">일</td>
			<td bgcolor="white" align="center">월</td>
			<td bgcolor="white" align="center">화</td>
			<td bgcolor="white" align="center">수</td>
			<td bgcolor="white" align="center">목</td>
			<td bgcolor="white" align="center">금</td>
			<td bgcolor="white" align="center">토</td>
		</tr>
		<%
			int newLine = 0;
		...
		for (int i = startDay; i <= endDay; i++) {
			...
			String bgColor = (nowYear == year) && ((nowMonth+1) == month) && (nowDay == i) ? "yellow" : "#ffffff";
